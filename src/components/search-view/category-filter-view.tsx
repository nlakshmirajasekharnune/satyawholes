...
const CategoryFilterView = ({ categories }: Props) => {
  ...
  if(findParent!=undefined)
  {
    ...
    {
      tempcat=categories.filter(d=>d.parent_id==findParent.id);
    }
  }
  ...
  return (
    <div className="relative -mb-5 after:absolute after:bottom-0 after:flex after:h-6 after:w-full ltr:after:left-0 rtl:after:right-0">
