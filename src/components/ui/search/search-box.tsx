...
const classes = {
  ...
  minimal:
    'search-minimal bg-gray-100 ltr:pl-10 rtl:pr-10 ltr:pr-4 rtl:pl-4 ltr:md:pl-14 rtl:md:pr-14 border focus:border-accent focus:bg-light',
...
const SearchBox: React.FC<Props> = ({
  ...
  return (
    ...
    <form onSubmit={onSubmit} className={cn('lg:w-1/2 md:w-full mx-auto ', className)}>
      <div
        className={cn('relative flex rounded md:rounded-lg', {
          ...
          'h-10 shadow-downfall': variant === 'with-shadow',
        })}
      >
