    ...
    <>
      ...
      >
        {({ register, formState: { errors } }) => (
          <>
            ...
            <div className="mt-8">
              <Button
                className="h-11 w-full sm:h-12 !bg-blue-600 !text-light hover:!bg-blue-500 sm:h-12" 
                loading={isLoading}
                disabled={isLoading}
              >
                {t('text-login')}
      ...
      <div className="text-center text-sm text-body sm:text-base">
        ...
        <button
          ...
          className="font-semibold text-accent underline transition-colors text-blue-500 duration-200 hover:text-accent-hover hover:no-underline focus:text-accent-hover focus:no-underline focus:outline-none ltr:ml-1 rtl:mr-1"
        >
          {t('text-register')}
        </button>
      </div>
