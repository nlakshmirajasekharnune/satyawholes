      ...
      {!isMobile && (
        <div className="max-h-full flex-grow overflow-hidden">
          ...
          >
            {!notFound ? (
              <div className="px-5">
                <h6 className="w-full flex justify-between items-center focus:outline-none focus:ring-1 focus:ring-accent focus:ring-opacity-40 font-semibold">Category</h6>
                <TreeMenu items={categories} className="xl:py-2" />
              </div>
            ) : (
