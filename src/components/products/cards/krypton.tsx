...
const Krypton: React.FC<KryptonProps> = ({ product, className }) => {
  ...
  const { name, image, slug, min_price, max_price,ratings, product_type } =
    product ?? {};
        ...
        <header className="p-3 text-center md:p-6">
          ...
          {product_type.toLowerCase() === 'variable' ? (
            ...
            <><div className="flex items-center justify-center">
              ...
              </div><div className="inline-flex shrink-0 items-center rounded border border-accent bg-accent px-3 py-1 text-sm text-white">
                  {ratings}
