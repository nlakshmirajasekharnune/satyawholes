...
const HeaderMinimal = ({ layout }: { layout: string }) => {
  ...
  return (
    <header className={cn('site-header-with-search h-14 md:h-16 lg:h-22')}>
      <div
        className={cn(
          'fixed z-10 flex h-14 w-full items-center justify-between border-b border-border-200 bg-white px-4 py-5  shadow-sm transition-transform duration-300 md:h-16 lg:h-22 ltr:lg:pl-12 ltr:lg:pr-8 rtl:lg:pr-12 rtl:lg:pl-8',
          {
