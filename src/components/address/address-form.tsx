        ...
        return (
          <>
            ...
            <TextArea
              ...
              className="col-span-2"
            />
              {/* <input id="checkbox-1" className="checkbox-custom" name="checkbox-1" type="checkbox" onChange={setCheckstate} checked={isChecked}/> */}
              {(defaultValues.type!="shipping")?(<Checkbox
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {defaultValues.title!="" ? t('text-update') : t('text-save')}{' '}
              {t('text-address')}
            </Button>
          </>
        );
...
export default function CreateOrUpdateAddressForm() {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    const formattedInput1 = {
      ...
      // customer_id: customerId,
      title: values.title,
      type: values.type=="shipping"?AddressType.Billing:AddressType.Shipping,
      address: {
        ...values.address,
      },
      location: values.location,
