...
export interface CategoryListQueryOptions extends QueryOptions {
  language: string;
  parent: string | null;
  type: string;
  parentId:string;
...
export interface User {
  ...
  business_license_reason:string;
  tobacco_license_reason:string;
...
export interface AuthResponse {
  ...
  business_license_verify:string;
}
