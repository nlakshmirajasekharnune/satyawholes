import type { CategoryListQueryOptions, CategoryPaginator, CategoryQueryOptions } from '@/types';
...
console.log
  ...
  formattedOptions.limit=1000;
  formattedOptions.type="satya-wholesale";
...
export function useCategorieslist(options?: Partial<CategoryListQueryOptions>) {
  const { locale } = useRouter();
